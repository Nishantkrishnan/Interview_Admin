...
import {handleDrawerOpen, handleDrawerClose, handleRolesOnClick,handleActionsOnClick,handleRoleActionOnClick} from '../../redux/actions';
...
const useStyles = makeStyles(theme => ({
 ...
 const Menu = (props) => {
   const {open, handleDrawerOpen, handleDrawerClose, handleRolesOnClick,handleActionsOnClick,
     handleRoleActionOnClick, history } = props;
    ...
    <CssBaseline />
        ...
        < Grid container className = "dashboardContent">
          ...
          <Toolbar disableGutters={!open}>
            ...
            <Grid item md={11}>
            <Typography style= {{ fontFamily: '"Apple Color Emoji"'}} variant="h5" color="inherit" noWrap>
              GoodWorkLabs
            </Typography>
              </Grid>
            ...
            <Button  style= {{ color: " aliceblue"}}  ><i class="material-icons"  >
power_settings_new
</i></Button>
            </Typography>
              </Grid>
...
const mapDispatchToProps=dispatch=>{
 return ({
   ...
   handleActionsOnClick:(history)=>{dispatch(handleActionsOnClick(history))},
   handleRoleActionOnClick : (history) => {dispatch (handleRoleActionOnClick(history))}
 });
};
