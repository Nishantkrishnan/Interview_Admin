  ...
  return (
    ...
    >
      <Grid container direction="row" justify="center">
        <DialogTitle style={{ display: "center" }} id="simple-dialog-title">
          {dialog.title}
        </DialogTitle>
          ...
          <Grid item md={6}>
            <FormControl className={classes.formControl}>
              ...
              <Select
                ...
                value={roleNames}
                onChange={e => {
                  handleFieldChange("roleNames", e.target.value, "roleAction");
                }}
            ...
            <FormControl className={classes.formControl}>
              ...
              >
                {actionList.map((action, index) => {
                  return (
                    <MenuItem key={action.actionName} value={action.actionName}>
                      {action.actionName}
                    </MenuItem>
                  );
                })}
