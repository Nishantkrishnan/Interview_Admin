      ...
      <Grid item md={12} classes={{ root: "displaying" }}>
        ...
        >
          ...
          <TextField
            ...
            onChange={e =>
              handleFieldChange("actionName", e.target.value, "actions")
            }
          />
          ...
          <TextField
            ...
            margin="normal"
            variant="outlined"
            value={actions.routePath}
            onChange={e =>
              handleFieldChange("routePath", e.target.value, "actions")
            }
          />
          ...
          <Button
            ...
            variant="contained"
            onClick={() => {
              fun(dialog, onClickCreateAction, onClickUpdateAction, id);
            }}
          >
            {dialog.buttonName}
          </Button>
...
const mapDispatchToProps = dispatch => {
  return {
    onClickCreateAction: () => {
      dispatch(onClickCreateAction());
    },
    onClickUpdateAction: id => {
      dispatch(onClickUpdateAction(id));
    },
